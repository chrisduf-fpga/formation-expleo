...
end entity circuit_q9;


-- RTL architecture.
--
architecture RTL of circuit_q9 is
  ...
  -- F2S pulse duration in clk_A clock period.
  constant F2S_PULSE_LEN  : positive := 10;
  ...
  signal r_pulse_f2s      : integer range 0 to F2S_PULSE_LEN := 0;
  -- Intermediate signal to avoid logic duplication.
  signal w_stretching     : std_logic;

  -- PLL Primitive output clocks.
